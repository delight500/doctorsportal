...
CREATE TABLE `patients` (
  ...
  `p_potrait` varchar(400)  NULL,
  `image1` varchar(400) NULL, 
  `image2` varchar(400)  NULL,
  `image3` varchar(400)  NULL,
  `image4` varchar(400)  NULL,
  `image5` varchar(400)  NULL,
  `image6` varchar(400)  NULL,
  `image7` varchar(400)  NULL,
  `image8` varchar(400)  NULL,
  `image9` varchar(400)  NULL,
  `scan1` varchar(400)  NULL,
  `scan2` varchar(400)  NULL,
...
INSERT INTO `patients` (`patient_id`, `p_fname`, `p_lname`, `p_mname`, `gender`, `ship_address`, `dob`, `clinical_conditions`, `other`, `notes`, `treatment_option`, `status`, `p_potrait`,`image1`,`image2`,`image3`,`image4`,`image5`,`image6`,`image7`,`image8`,`image9`,`scan1`,`scan2`, `startdate`) VALUES
